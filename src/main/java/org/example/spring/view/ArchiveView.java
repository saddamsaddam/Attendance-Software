...
public class ArchiveView {
    ...
    BorderPane createTab(RepositoryManager repositoryManager1, List<EmployeeData> employeeList1, List<EmployeeInsertedData> dataList1) {
        ...
        employeeList = AddEmployeeController.ArchiveRetrieveData(repositoryManager);
        dataList=null;
        ...
        Tab tabEmploy = new Tab();
        tabEmploy.setGraphic(createTabHeader("Employee"));
        tabEmploy.setClosable(false); // Set the tab to be closable
        StackPane tabContentEmploy =new StackPane();
        tabContentEmploy.getChildren().add(new ArchiveAddEmployeeView().createTab(repositoryManager,employeeList));
        tabEmploy.setContent(tabContentEmploy);
        tabPane.getTabs().add(tabEmploy);
        ...
        tabSetting.setGraphic(createTabHeader("Download"));
        ...
        tabPane.getSelectionModel().selectedItemProperty().addListener((observable, oldTab, newTab) -> {
            ...
            switch (selectedIndex) {
                case 0:
                   ...
                   // updatePanel(tabContentEmploy,new SummaryDataView().createTab(repositoryManager,employeeList,dataList,globalSettingdata,localSettingdata));
                    updatePanel(tabContentEmploy,new ArchiveAddEmployeeView().createTab(repositoryManager,employeeList));
                ...
                case 3:
                    ...
                    updatePanel(tabContentSetting,new DownloadView().createTab(globalSettingdata,localSettingdata,employeeList,dataList));
                    // Handle the content update for the second tab
                    break;
